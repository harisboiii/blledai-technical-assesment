...
from fastapi import FastAPI, HTTPException, Depends, File, UploadFile  # FastAPI components for handling HTTP requests
...
# Pydantic model for request body when creating a user
class UserRequest(BaseModel):
    name: str = Field(min_length=1)  # Validate minimum length of name field
